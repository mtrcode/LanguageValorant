...
namespace LanguageValorant
{
    public partial class Form1 : Form
    {
        ...
        {
            Process.Start(@"C:\Program Files\Riot Games\Riot Client\RiotClientServices.exe", "--launch-product=valorant --launch-patchline=live");
        }
        ...
        {
            if (!RenameAndReplace_checkBox.Checked)
                Process.Start(@"C:\Program Files\Riot Games\Riot Client\RiotClientServices.exe");
            else
            {
                if (md5Files.Count == 0)
